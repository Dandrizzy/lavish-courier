  ...
  <div className=" p-4 grid gap-8 bg-red-50/30 text-slate-900">
   ...
   <div className="">
    <h1 className=" text-center lg:text-4xl text-2xl font-semibold">
     We take the <br />
     <span className=" text-orange-500 ">burden of logistics off you.</span>
    </h1>
   </div>
   ...
   <div className="grid lg:grid-cols-2 gap-8">
    ...
    <div className=" bg-[url('/3.jpg')] bg-cover shadow-md border-t-2 px-4 py-8">
     <div className="backdrop-blur-lg text-neutral-50 font-bold p-4 max-w-md backdrop-invert-0 mx-auto">
      <FaTruckFast className=" text-4xl text-orange-500" />
    ...
    <div className=" shadow-md border-t-2 px-4 py-8 bg-cover bg-[url('/air.jpg')] ">
     <div className=" mx-auto backdrop-blur-lg text-neutral-50 font-bold p-4 max-w-md backdrop-invert-0">
      ...
      <FaDelicious className=" text-4xl text-orange-500" />
    ...
    <div className="shadow-md border-t-2 px-4 py-8 bg-cover bg-[url('/12.jpg')] ">
     ...
     <div className=" mx-auto backdrop-blur-lg text-neutral-50 font-bold p-4 max-w-md backdrop-invert-0">
      ...
      <GiStack className=" text-4xl text-orange-500" />
    ...
    <div className="bg-cover bg-[url('/6.jpg')] shadow-md border-t-2 px-4 py-8">
     <div className=" mx-auto backdrop-blur-lg text-neutral-50 font-bold p-4 max-w-md backdrop-invert-0">
      <FaCloudMoon className=" text-4xl text-orange-500" />
    ...
    <div className="bg-cover bg-[url('/05.jpg')] shadow-md border-t-2 px-4 py-8">
     <div className=" mx-auto backdrop-blur-lg text-neutral-50 font-bold p-4 max-w-md backdrop-invert-0">
      ...
      <p>At Golden ExpressHub, we&apos;re thrilled to introduce a revolutionary chapter in courier services tailored just for you. Picture this-real-time tracking at your fingertips, swift drone deliveries, and personalized experiences driven by state-of-the-art technology.</p>
     </div>
    </div>
